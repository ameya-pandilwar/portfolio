...
public class SudokuKeypadDialog extends Dialog {
   ...
   protected static final String TAG = "SudokuKeypadDialog";
   ...
   public SudokuKeypadDialog(Context context, int useds[], SudokuPuzzleView sudokuPuzzleView) {
      super(context);
      this.useds = useds;
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.dialog_sudoku_keypad);
      findViews();
