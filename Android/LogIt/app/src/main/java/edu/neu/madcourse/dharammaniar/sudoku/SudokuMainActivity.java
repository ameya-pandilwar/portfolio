...
public class SudokuMainActivity extends Activity implements OnClickListener {
   ...
   public void onClick(View v) {
      ...
      case R.id.continue_button:
         startGame(SudokuGameActivity.DIFFICULTY_CONTINUE);
         break;
         // ...
      case R.id.about_button:
         Intent i = new Intent(this, SodukuAboutActivity.class);
         startActivity(i);
         break;
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
      ...
      case R.id.settings:
         startActivity(new Intent(this, SudokuPrefActivity.class));
         return true;
   ...
   private void startGame(int i) {
      ...
      intent.putExtra(SudokuGameActivity.KEY_DIFFICULTY, i);
