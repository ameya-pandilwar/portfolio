 ...
 */
public class TwoPlayerBananagramsFindFriends extends Activity {
    ...
    private LinearLayout find_user_linear_layout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_two_player_bananagrams_find_user);
        find_user_linear_layout = (LinearLayout) findViewById(R.id.find_user_linear_layout);
        tutorial = (ImageView) findViewById(R.id.tutorial);
        tutorial.setImageResource(R.drawable.start);
        i = 0;
        tutorial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                i++;
                if (i == 1) {
                    tutorial.setImageResource(R.drawable.time);
                }
                if (i == 2) {
                    tutorial.setImageResource(R.drawable.points);
                }
                if (i == 3) {
                    tutorial.setImageResource(R.drawable.opponent);
                }
                if (i == 4) {
                    tutorial.setImageResource(R.drawable.peel);
                }
                if (i == 5) {
                    tutorial.setImageResource(R.drawable.dump);
                }
                if (i == 6) {
                    tutorial.setImageResource(R.drawable.shake);
                }
                if (i > 6) {
                    find_user_linear_layout.removeView(tutorial);
                }
            }
        });
        listView = (ListView) findViewById(R.id.activity_two_player_bananagrams_find_user_listView);
