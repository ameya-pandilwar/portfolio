...
import edu.neu.madcourse.dharammaniar.communication.CommunicationConstants;
import edu.neu.madcourse.dharammaniar.communication.FindUserActivity;

/**
 * Created by Dharam on 10/29/2014.
 */
public class TwoPlayerBananagramsRegistration extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_player_bananagrams_registration);
        initializeMembers();
    }

    private void initializeMembers() {
        username = (EditText) findViewById(R.id.activity_two_player_bananagrams_et_username);
        register = (Button) findViewById(R.id.activity_two_player_bananagrams_bt_register);
